import { FileText, FileUp, Globe, Link as LinkIcon, List } from "lucide-react";
import { useState } from "react";
import { Card, CardContent } from "@/components/ui/card";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { FileUploadForm } from "./file-upload-form";
import { SitemapSourceForm } from "./sitemap-source-form";
      ...
      <CardContent className="p-6">
        <Tabs className="w-full" onValueChange={setActiveTab} value={activeTab}>
          <TabsList className="grid w-full grid-cols-5">
            ...
            <TabsTrigger className="gap-2" value="sitemap">
          ...
          <TabsContent className="mt-6 space-y-4" value="sitemap">
            <SitemapSourceForm
              botId={botId}
              onCancel={() => setActiveTab("list")}
              onSuccess={() => setActiveTab("list")}
